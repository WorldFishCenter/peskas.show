...
function Blog({ posts }) {
    return (
        <>
            <Head>
                <title>Peskas Blog - Technical and not so technical musings about the Peskas platform</title>
                <meta name="description" content="Technical and not so technical musings about the Peskas platform" />
            </Head>
            <Layout>
