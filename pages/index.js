                            ...
                            <div className="row" style={{ paddingBottom: 40 }}>
                                <div className="col-lg-7">
                                    ...
                                    <p className="text-body-lead-large color-gray-500 mt-40 pr-40">
                                        Peskas delivers real-time data and insights for small-scale
                                        fisheries to enable evidence-based decision-making at
                                        different scales, from fishers to national government.
                                        <br />
                                        <br />
                                        Harnessing user-centered design, agile and open science
                                        principles, Peskas paves the way for thriving small-scale
                        ...
                        <div className="container">
                            <div className="row justify-content-md-center">
                                <div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
                                    <Link href="https://www.pelagicdata.com/" legacyBehavior>
                                        <a className="item-logo box-hover-shadow hover-up ">
                                            <img
                                                alt="Agon"
                                                src="assets/imgs/slider/logo/pds-logo.svg"
                                            />
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
                                    <Link
                                        href="https://customs.gov.tl/other-gov-agencies/ministry-of-agriculture-fisheries/"
                                        legacyBehavior
                                    >
                                        <a className="item-logo box-hover-shadow hover-up">
                                            <img
                                                alt="Agon"
                                                src="assets/imgs/slider/logo/maf-logo.svg"
                                            />
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
                                    <Link href="https://blueventures.org/" legacyBehavior>
                                        <a className="item-logo box-hover-shadow hover-up">
                                            <img
                                                alt="Agon"
                                                src="assets/imgs/slider/logo/blue-ventures-logo.svg"
                                            />
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
                                    <Link href="https://www.wcs.org/" legacyBehavior>
                                        <a className="item-logo box-hover-shadow hover-up">
                                            <img
                                                alt="Agon"
                                                src="assets/imgs/slider/logo/wcs-logo.svg"
                                            />
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
                                    <Link
                                        href="https://trade.tanzania.go.tz/Contacts/84?l=en"
                                        legacyBehavior
                                    >
                                        <a className="item-logo box-hover-shadow hover-up">
                                            <img
                                                alt="Agon"
                                                src="assets/imgs/slider/logo/zanzibar-be-logo.svg"
                                            />
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
                                    <Link href="https://www.wiomsa.org/" legacyBehavior>
                                        <a className="item-logo box-hover-shadow hover-up">
                                            <img
                                                alt="Agon"
                                                src="assets/imgs/slider/logo/wiomsa-logo.svg"
                                            />
                                        </a>
                                    </Link>
                                </div>
                                ...
                                <div className="bg-5 panel-box mt-50">
                                    <div className="row">
                                        <div className="col-lg-6 col-sm-12">
                                            <div className="box-optimized">
                                                <h3 className="text-heading-2">Malaysia</h3>
                                                <p className="text-body-excerpt mt-30">
                                                    Malaysia is the host country of WorldFish
                                                    headquarters and we work closely with the
                                                    Department of Fisheries and Malaysian
                                                    universities to develop research in fisheries
                                                    and aquaculture. Peskas pilots have so far been
                                                    deployed in Pulau Pinang and Kedah states.
                                                </p>
                                                <div className="mt-40">
                            ...
                            >
                                <div className="bg-5 panel-box mt-50">
                                    <div className="row">
                                        <div className="col-lg-6 col-sm-12">
                                            <div className="box-optimized">
                                                <h3 className="text-heading-2">Kenya</h3>
                                                <p className="text-body-excerpt mt-30">
                                                    With funding from the UK Government, Kenya is
                                                    one of the scaling countries for Peskas as part
                                                    of the AABS project. With partners Wildlife
                                                    Conservation Society (WCS) and KMFRI, Peskas is
                                                    being deployed and tested in Kenya to explore
                                                    behaviour change in response to fisheries
                                                    information.
                                                </p>
                                                <div className="mt-40">
                                                    <Link href="/under-costruction" legacyBehavior>
                            ...
                            >
                                <div className="bg-5 panel-box mt-50">
                                    <div className="row">
                                        <div className="col-lg-6 col-sm-12">
                                            <div className="box-optimized">
                                                <h3 className="text-heading-2">Zanzibar</h3>
                                                <p className="text-body-excerpt mt-30">
                                                    With partners WIOMSA and the Ministry of Blue
                                                    Economy and Fisheries, WorldFish are developing
                                                    a fisheries information system for Unguja and
                                                    Pemba in Zanzibar, built on the Peskas system
                                                    platform.
                                                </p>
                                                <div className="mt-40">
                                                    <Link href="/under-costruction" legacyBehavior>
                            ...
                            >
                                <div className="bg-5 panel-box mt-50">
                                    <div className="row">
                                        <div className="col-lg-6 col-sm-12">
                                            <div className="box-optimized">
                                                <h3 className="text-heading-2">Mozambique</h3>
                                                <p className="text-body-excerpt mt-30">
                                                    Mozambique is a focal country of the AABS
                                                    project and WorldFish are currently exploring a
                                                    partnership with the Ministry of Seas, Inland
                                                    Waters and Fisheries (MIMAIP) and other NGOs to
                                                    support national development objectives related
                                                    to the fisheries sector and digital
                                                    transformation.
                                                </p>
                                                <div className="mt-40">
                                                    <Link href="/under-costruction" legacyBehavior>
                            ...
                            >
                                <div className="bg-5 panel-box mt-50">
                                    <div className="row">
                                        <div className="col-lg-6 col-sm-12">
                                            <div className="box-optimized">
                                                <h3 className="text-heading-2">Malawi</h3>
                                                <p className="text-body-excerpt mt-30">
                                                    Malawi is a landlocked country in southern
                                                    Africa, but is still highly reliant upon
                                                    productive freshwater lake fisheries. WorldFish,
                                                    with funding from SADC, are working to leverage
                                                    Peskas approaches to provide evidence for
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 col-sm-10 col-12 text-center mt-100">
                                ...
                                <p className="text-body-lead-large color-gray-600 mt-20">
                                    ...
                                    forward-thinking and innovative strategies. Peskas consists of
                                    six main modules:
                                </p>
                                <div className="mt-40">
                                    <Link href="under-costruction" legacyBehavior>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-12 card-homepage">
                                <div className="card-grid-1 bg-1 bg-business hover-up">
                                    ...
                                    <p className="text-body-excerpt mt-20">
                                        ...
                                        capture of efforts and aligns with stakeholders&apos;
                                        objectives.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 card-homepage">
                                <div className="card-grid-1 bg-1 bg-local hover-up">
                                    ...
                                    <p className="text-body-excerpt mt-20">
                                        ...
                                        standardized formats for immediate access and practical
                                        application, while ensuring compatibility and alignment with
                                        established data ontologies.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 card-homepage">
                                <div className="card-grid-1 bg-1 bg-social hover-up">
                                    ...
                                    <p className="text-body-excerpt mt-20">
                                        Analyzing data to uncover trends and patterns that inform
                                        sustainable fishing practices, integrating local knowledge
                                        and context-specific insights to bolster fishery management.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 card-homepage">
                                <div className="card-grid-1 bg-1 bg-local hover-up">
                                    ...
                                    <p className="text-body-excerpt mt-20">
                                        Ensuring accurate and reliable data, this module rigorously
                                        scrutinizes and refines the information, utilizing robust
                                        methods to identify and correct discrepancies.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 card-homepage">
                                <div className="card-grid-1 bg-1 bg-local hover-up">
                                    ...
                                    <p className="text-body-excerpt mt-20">
                                        Translating complex data into interactive dashboards and
                                        detailed reports, this module promotes understanding and
                                        data-driven decisions, making sustainable fishing insights
                                        widely accessible.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 card-homepage">
                                <div className="card-grid-1 bg-1 bg-local hover-up">
                                    ...
                                    <p className="text-body-excerpt mt-20">
                                        Enabling active participation platforms, ensuring
                                        stakeholders&apos; insights continually shape and improve
                                        the process, promoting a shared journey towards sustainable
                                        fisheries.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-12 pr-30">
                                <div className="card-grid-style-4">
                                    ...
                                    <Link
                                        href="https://blog.peskas.org/posts/shorthands/"
                                        legacyBehavior
                                    >
                                        <a target="_blank" className="text-heading-4">
                                            A DAY WITH A SMALL-SCALE FISHING COMMUNITY AT KANAMAI
                                            BEACH, KENYA
                                        </a>
                                    </Link>
                            ...
                            <div className="col-lg-4 col-sm-12 pr-30">
                                <div className="card-grid-style-4">
                                    ...
                                    <Link
                                        href="https://blog.peskas.org/posts/world-fishers-day/"
                                        legacyBehavior
                                    >
                                        <a target="_blank" className="text-heading-4">
                                            WORLD FISHERIES DAY: CELEBRATING THE PEOPLE BEHIND THE
                                            NUMBERS
                                        </a>
                                    </Link>
                                    <div className="grid-4-img">
                            ...
                            <div className="col-lg-4 col-sm-12 pr-30">
                                <div className="card-grid-style-4">
                                    ...
                                    <Link
                                        href="https://blog.peskas.org/posts/africa-trip/"
                                        legacyBehavior
                                    >
                                        <a target="_blank" className="text-heading-4">
                                            FROM LITTLE THINGS, BIG THINGS GROW: SCALING PESKAS IN
                                            EAST AFRICA
                                        </a>
                                    </Link>
                                    <div className="grid-4-img">
